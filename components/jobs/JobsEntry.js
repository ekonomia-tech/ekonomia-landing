...
export default function JobEntry({ data }) {
	...
	return (
		<div className="border border-primary rounded-xl px-6 pt-8 pb-6 my-4">
			...
			<div className="w-full flex justify-end">
				<button
					className={`bg-gradient-to-r from-gradient-3 to-gradient-7 bg-shadow rounded-full py-1.5 px-4 text-accent mt-4 w-fit shadow-xl border border-primary cursor-pointer text-xs ml-auto`}
